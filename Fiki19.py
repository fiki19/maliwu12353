...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;97mNamamu siapa boss ? \033[1;91m: \033[1;92m")
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mSelamat datang \033[1;92m" +nama+ "\n\033[1;97mTerimakasih telah menggunakan tools ini dosa tanggung sendiri bossqu !!")
		time.sleep(1)
		loginSC()
